 ...
 */
final class Version20250319213012 extends AbstractMigration
{
    ...
    //    // $this->addSql('ALTER TABLE compte_client DROP relation_id, CHANGE client_id client_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        // //$this->addSql('ALTER TABLE compte_client ADD relation_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL');
