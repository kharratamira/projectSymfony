 ...
 */
final class Version20250322020032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE user ADD user_type VARCHAR(255) NOT NULL, DROP client_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE user ADD client_id INT NOT NULL, DROP user_type');
